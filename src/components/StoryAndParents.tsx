    ...
    <>
      <ScrollReveal delay={0.2}>
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}>
          <svg width="42" height="42" viewBox="0 0 24 24" fill="var(--accent-gold)" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.25 }}>
      ...
      <ScrollReveal delay={0.3}>
        <div style={{ display: "flex", justifyContent: "center", margin: "3.5rem 0" }}>
          <svg width="180" height="24" viewBox="0 0 180 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 12H170" stroke="var(--accent-gold)" strokeWidth="1" strokeDasharray="6 6" opacity="0.3"/>
            <circle cx="90" cy="12" r="6" fill="var(--bg-light)" stroke="var(--accent-gold)" strokeWidth="1.5"/>
            <circle cx="90" cy="12" r="2.5" fill="var(--accent-gold)"/>
            <path d="M76 12L82 7L82 17L76 12Z" fill="var(--accent-gold)" opacity="0.5"/>
            <path d="M104 12L98 7L98 17L104 12Z" fill="var(--accent-gold)" opacity="0.5"/>
          </svg>
        </div>
      </ScrollReveal>
